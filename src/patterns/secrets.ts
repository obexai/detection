...
export const secretsPatterns: PiiPattern[] = [
  ...
  {
    type: "api_key",
    regex: /(?:api[_-]?key|apikey|api[_-]?secret|api[_-]?token|auth[_-]?token|access[_-]?token|secret[_-]?key|private[_-]?key)[\s]*[=:]\s*["']?([A-Za-z0-9\-_.]{20,})["']?/gi,
    confidence: 0.85,
  },
  ...
  {
    type: "api_key",
    regex: /\bxox[bpars]-[0-9a-zA-Z-]{10,}/g,
    confidence: 0.95,
  },
